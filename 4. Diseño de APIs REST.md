...
En nuestro caso, el backend está construido en **Java con Spring Boot** y la información se transfiere mediante el **protocolo HTTP**, generalmente usando el formato **JSON** por su simplicidad, legibilidad e independencia del lenguaje de programación (aunque también se pueden usar HTML, XML o texto plano). 

HTTP define métodos que indican al servidor qué acción realizar, estos métodos indican el **tipo de operación** que se desea realizar sobre los recursos:

- **GET** → Obtener datos (sin modificar el servidor).
- **POST** → Crear datos o realizar acciones que cambien el estado de los recursos.
...
### **3. Creación del Archivo OpenAPI**
...
2. Generar el código base utilizando Swagger Codegen.
3. Implementar las operaciones en Spring Boot.
4. Desplegar el proyecto y verificar su correcto funcionamiento.
