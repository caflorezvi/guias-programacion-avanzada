...
Tenga en cuenta que es necesario crear el método `findByEmail` en el repositorio `UserRepository` para validar si el correo electrónico ya está en uso. Cree el método así:
