...
El atributo `nativeQuery = true` indica que se trata de una consulta SQL nativa, por lo que se debe usar exactamente la sintaxis, nombres de tablas y columnas definidos en la base de datos.
