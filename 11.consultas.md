...
Este es un ejemplo de una consulta JPQL (Java Persistence Query Language) que selecciona todos los usuarios cuyo nombre coincide con el valor proporcionado en el parámetro `:name`.
