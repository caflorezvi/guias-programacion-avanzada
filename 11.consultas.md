...
```
En este ejemplo, se está utilizando una consulta SQL nativa para seleccionar usuarios cuya edad sea mayor que un valor específico. El atributo `nativeQuery = true` indica que la consulta es SQL nativa.
...
> ⚠️ **Importante:** En el proyecto final puede usar el enfoque que más le guste o puede usar ambos. Hay total libertad.
...
- Investigue sobre `Criteria`, identificando las ventajas que ofrece en comparación con lo explicado en esta guía, así como las desventajas que presenta.
