...
- **Java y Spring Boot:** Lenguaje de programación y framework para el desarrollo de aplicaciones web y servicios backend.
- **Servicios de negocio:** Lógica de negocio que maneja las operaciones y reglas de la aplicación.
