...
Asegúrese de tener Lombok configurado en su proyecto ya que vamos a utilizarlo para simplificar la creación de objetos. Para más información acerca de cómo utilizar Lombok, consulte la [documentación oficial](https://projectlombok.org/features/all).
